...
export default ({
  text = "Are You Interested In Learning React",
  primaryLinkText = "ClicK Here ",
  primaryLinkUrl = "https://levbitz.com/reactNative.html",
  secondaryLinkText = "Contact Us",
  secondaryLinkUrl = "https://wa.link/ax5bxz",
  pushDownFooter = true,
}) => {
  return (
